...
Additionally, batches of jobs can be scheduled as an [array](https://slurm.schedmd.com/job_array.html) by navigating to the CLI directory and executing the `array_cli.sh` script

```bash
$ cd func_model/func_model/cli
$ ./array_cli.sh
```
...
### Montage and Cluster Table Generation
...
(emorep)[nmm51-vm: bin]$./lmer_montages.sh
    ...
    Example Usage:
        ./lmer_montages.sh -s stat-lmer_model-mixed
